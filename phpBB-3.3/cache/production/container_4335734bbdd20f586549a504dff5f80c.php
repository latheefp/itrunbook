...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'kasimi.loginrequired.listener' => 'getKasimi_Loginrequired_ListenerService',
        ...
        $this->privates = [
            ...
            'hook_finder' => true,
            'http_kernel' => true,
            'kasimi.loginrequired.listener' => true,
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addListener('core.user_setup', [0 => function () {
            return ${($_ = isset($this->services['kasimi.loginrequired.listener']) ? $this->services['kasimi.loginrequired.listener'] : $this->getKasimi_Loginrequired_ListenerService()) && false ?: '_'};
        }, 1 => 'login_required'], 1000);
    ...
    /**
     * Gets the private 'kasimi.loginrequired.listener' shared service.
     *
     * @return \kasimi\loginrequired\event\listener
     */
    protected function getKasimi_Loginrequired_ListenerService()
    {
        return $this->services['kasimi.loginrequired.listener'] = new \kasimi\loginrequired\event\listener(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, 'php');
    }
