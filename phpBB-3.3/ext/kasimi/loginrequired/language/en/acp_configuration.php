...
$lang = array_merge($lang, array(
	...
	'LOGINREQUIRED_EXCEPTIONS_EXP'		=> 'By default all pages require users to login to access them. If you want to allow access to specific pages without logging in, list them here, one per line. Examples:<ul><li style="font-size:0.95em">To grant guests access to the FAQ, use "faq.php" (for phpBB 3.1.x) or "app.php/help/faq" (for phpBB 3.2.x, without quotes).</li><li style="font-size:0.95em">To grant guests access to an extension’s route at /coolextension, use "app.php/coolextension" (without quotes).</li><li style="font-size:0.95em">To grant guests access to a custom page located at /custom/page.php, use "custom/page.php" (without quotes).</li></ul>',
));
