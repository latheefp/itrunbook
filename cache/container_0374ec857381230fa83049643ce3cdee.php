...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'phpBB', 'bfZ6eWAanBVEfqrM', 'phpBB', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('kasimi.loginrequired.listener', 'kasimi\\loginrequired\\event\\listener');
    ...
    /**
     * Gets the 'kasimi.loginrequired.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \kasimi\loginrequired\event\listener A kasimi\loginrequired\event\listener instance.
     */
    protected function getKasimi_Loginrequired_ListenerService()
    {
        return $this->services['kasimi.loginrequired.listener'] = new \kasimi\loginrequired\event\listener($this->get('user'), $this->get('config'), 'php');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'phpBB',
            'dbal.dbpasswd' => 'bfZ6eWAanBVEfqrM',
            'dbal.dbname' => 'phpBB',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
